...
def crwal_wishket():
    with sync_playwright() as p:
        ...
        page.fill('input[name="emailOrId"]', 'skarlfyd88')
        page.fill('input[name="password"]', 'vkqmfcjsgk8!')
        ...
        registered_profects = page.inner_text('xpath=/html/body/div[2]/div/div[1]/div[2]/div[2]/div[1]/div[5]/div[1]/p')
        ...
        result = {
            ...
            "등록된_프로젝트": registered_profects,
            "계약된 프로젝트": contracted_projects,
        ...
        with open(csv_path, "a", encoding="utf-8-sig") as f:
            ...
            f.write(f'{result["수집일시"]},{registered_profects},{contracted_projects},{completed_amount}\n')
